...
//    document.body.classList.add('body--ready');
    document.getElementById('daoJishi').classList.add('body--ready');
...
//      canvas = document.querySelector(el);
      canvas = document.getElementById('daoJishi').querySelector(el);
...
//      canvas = document.querySelector('.canvas'),  
  var input = $('#daoJishi .ui-input')[0],
      ui = $('#daoJishi .ui')[0],
      help = $('#daoJishi .help')[0],
      commands = $('#daoJishi .commands')[0],
      overlay = $('#daoJishi .overlay')[0],
      canvas = $('#daoJishi .canvas')[0],
      interval,
  ...
  function performAction(value) {
    ...
    timedAction(function () {
      ...
      case 'icon':
        S.ShapeBuilder.imageFile(window.location.href.split('?')[0]+'lib/djs/font-awesome/' + value + '.png', function (obj) {
  ...
  function bindEvents() {
    document.getElementById('daoJishi').addEventListener('keydown', function (e) {
      input.focus();
...
//    add click
    document.getElementById('djsClick').addEventListener('click', function (e) {
        input.focus();
        firstAction = false;
        reset();
        performAction(input.value);
...
//        document.body.classList.add('touch');
        document.getElementById('daoJishi').classList.add('touch');
      }
...
//      panels = document.querySelectorAll('.tabs-panel');
  var labels = $('#daoJishi .tabs-labels')[0],
      triggers = $('#daoJishi .tabs-label'),
      panels = $('#daoJishi .tabs-panel');
...
S.ShapeBuilder = (function () {
  var gap = 13,
      ...
      fontSize = 500,
      fontFamily = 'Avenir, Helvetica Neue, Helvetica, Arial,微软雅黑, sans-serif';
